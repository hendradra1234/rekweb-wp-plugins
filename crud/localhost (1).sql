CREATE TABLE `tbl_pelanggan_crud` (
...
INSERT INTO `tbl_pelanggan_crud` (`kode_pelanggan`, `nama_pelanggan`, `alamat`) VALUES
...
INSERT INTO `tbl_barang_crud` (`kode_barang`, `nama_barang`, `harga`) VALUES
